...
:error_location
echo Doesn't seem like this script is in Silver Wrapper: Offline's utilities folder.
goto end
:noerror_location
...
:: Confirmation
echo Are you sure you'd like to reset Silver Wrapper: Offline?
...
echo :: Silver Wrapper: Offline Config>> utilities\config.bat
